...
exports.initTable = async function (db) {
    let info = await db.run("CREATE TABLE IF NOT EXISTS tblMinuAru (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, tsComes INT, tsGoes INT, tsAck INT, alarmText TEXT, alarmClass TEXT, alarmArea TEXT, stateID TEXT)");
    return info;
};
